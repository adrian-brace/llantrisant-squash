...
function showProvisionalRankings() {
	...
	var winterSeasonEndDate = new Date(2024, 11, 16, 0, 0, 0, 0);
	var finalRankingWinterListInBy = new Date(2024, 8, 1, 0, 0, 0, 0);
	var finalRankingSpringListInBy = new Date(2024, 11, 21, 0, 0, 0, 0);
